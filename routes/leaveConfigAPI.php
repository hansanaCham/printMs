...
Route::apiResource('/companyconfig/company', 'CompanyController');  // 
Route::apiResource('/costconfig/items', 'ItemcategoryController');  // 

Route::get('/companyconfig/company/{attribute}/{value}', 'CompanyController@value');
